...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">如果看到有说不能访问</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/.ssh/authorized_keys</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 这个文件的，可以尝试下修改.ssh目录的权限为700，authorized_keys</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 文件的权限为</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 600</span></span></code></pre></div>`,8),t=[p];function h(e,k,r,F,d,g){return a(),i("div",null,t)}const y=s(l,[["render",h]]);export{o as __pageData,y as default};
