import{_ as s,c as i,o as a,a2 as n}from"./chunks/framework.DrxArEOS.js";const y=JSON.parse('{"title":"Vps的SSH","description":"Vps的SSH安全配置","frontmatter":{"title":"Vps的SSH","description":"Vps的SSH安全配置","head":[["meta",{"name":"keywords","content":"vps SSH 安全 配置"}]]},"headers":[],"relativePath":"docs/other/vps.md","filePath":"docs/other/vps.md"}'),l={name:"docs/other/vps.md"},p=n(`<h3 id="debian-为例" tabindex="-1">debian 为例 <a class="header-anchor" href="#debian-为例" aria-label="Permalink to &quot;debian 为例&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 用root 登录之后 创建一个拥有root的用户</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">开启ECN</span></span></code></pre></div>`,4),h=[p];function t(k,e,F,r,d,c){return a(),i("div",null,h)}const o=s(l,[["render",t]]);export{y as __pageData,o as default};
